defmodule MultiStore.Supervisor do
  ...
  def init(_init_arg) do
    children = [
      ...
      Supervisor.child_spec({KVStore, name: :kv_store_a}, id: :kv_store_a),
      Supervisor.child_spec({KVStore, name: :kv_store_b}, id: :kv_store_b),
      Supervisor.child_spec({KVStore, name: :kv_store_c}, id: :kv_store_c)
    ]
