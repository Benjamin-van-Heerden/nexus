...
if len(devices) > 1:
    ...
    A_single = random.normal(random.PRNGKey(5), (1, 256, 256))
    B_single = random.normal(random.PRNGKey(6), (1, 256, 256))
...
# print(f"Compiled: {compiled_time:.4f}s, Raw: {raw_time:.4f}s, Speedup: {raw_time/compiled_time:.1f}x")
...
# Try: vmap(bad_relu)(jnp.array([1.0, -1.0, 2.0, -2.0]))
# What happens? Why?
